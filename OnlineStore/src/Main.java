...
//            , 1947, "H&M", 148000, 92);
        ...
        //todo:принимать товары от поставщиков
        ...
        // - в случае если привезен товар “id” которого ранее не присутствовал в магазине - необходимо увеличить массив
        // товаров, дополнив его новым товаром с новым “id” и указать “кол-во” нового товара
